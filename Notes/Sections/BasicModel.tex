...
\indent At $t^*$, actually, $I(t) = 0$ so earnings are $Y(t) = R H(t^*)$.\footnote{Miss-defined in slide 8} Then,
\begin{equation}
\ln Y(t^*) = \ln(RH_{0}) + (A - \sigma)t*.
\end{equation} 

\indent According to this model, the returns to schooling are given by the productivity of the human capital investment production function less the human capital depreciation.  

\section{The Interior Shenshinski Specification}
